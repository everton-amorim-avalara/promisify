...
type SrcFn11<R1, I1> = (i1: I1, cb: (err: Error, r1: R1) => any) => any
type SrcFn12<R1, R2, I1> = (i1: I1, cb: (err: Error, r1: R1, r2: R2) => any) => any
type SrcFn13<R1, R2, R3, I1> = (i1: I1, cb: (err: Error, r1: R1, r2: R2, r3: R3) => any) => any
...
interface PromisifyT {
    ...
    <R1, I1>(fn: SrcFn11<R1, I1>, i1: I1): Promise<[R1]>
    <R1, R2, I1>(fn: SrcFn12<R1, R2, I1>, i1: I1): Promise<[R1, R2]>
    <R1, R2, R3, I1>(fn: SrcFn13<R1, R2, R3, I1>, i1: I1): Promise<[R1, R2, R3]>
